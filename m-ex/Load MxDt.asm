...
rtocOffsets:
  ...
  .hword Arch_Fighter,Arch_Fighter_AnnouncerCall,-1 #effect create, need to implement this
  .hword Arch_Fighter,Arch_Fighter_AnnouncerCall,-1 #item functions, need to implement this
