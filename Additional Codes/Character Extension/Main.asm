...
#Down Special
  ...
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterDownSpecialLw(rtoc)
#Side Special
  bl  Fighter_SideSpecialLw
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterSideSpecialLw(rtoc)
#Neutral Special
  bl  Fighter_NeutralSpecialLw
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterNeutralSpecialLw(rtoc)
#Up Special
  bl  Fighter_UpSpecialLw
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterUpSpecialLw(rtoc)

#Down Special
  bl  Fighter_DownSpecialHi
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterDownSpecialHi(rtoc)
#Side Special
  bl  Fighter_SideSpecialHi
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterSideSpecialHi(rtoc)
#Neutral Special
  bl  Fighter_NeutralSpecialHi
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterNeutralSpecialHi(rtoc)
#Up Special
  bl  Fighter_UpSpecialHi
  mflr  r3
  bl  ConvertPointers
  stw r3,OFST_FighterUpSpecialHi(rtoc)
