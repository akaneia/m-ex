...
// variables
ClassicLineup *stc_clsc_lineup = 0x803ddec8;
u8 *stc_clsc_shuffledorder1 = 0x80490900; // 9 elements
u8 *stc_clsc_shuffledorder2 = 0x804908f4; // 10 elements
u8 *stc_clsc_shuffledorder3 = 0x804908d4; // 27 elements
u8 *stc_clsc_shuffledorder4 = 0x804908ac; // 38 elements
